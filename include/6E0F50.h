...
s32 func_800BDA20_jp(GraphicsContext* gfxCtx, s32 x, s32 y, s32 width, s32 height);
s32 two_tex_scroll(GraphicsContext* gfxCtx, 
                   s32 tile1, u32 x1, u32 y1, s32 width1, s32 height1, 
